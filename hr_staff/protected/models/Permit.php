 ...
 * @property string $describe_need
 *
 * The followings are the available model relations:
 * @property Emp $emp
 * @property Permitdetil[] $permitdetils
 * @property Permitdetil[] $permitdetils1
 */
class Permit extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('need, describe_need', 'length', 'max'=>45),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, emp_id, need, describe_need', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'permitdetils' => array(self::HAS_MANY, 'Permitdetil', 'permit_id'),
			'permitdetils1' => array(self::HAS_MANY, 'Permitdetil', 'permit_emp_id'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('describe_need',$this->describe_need,true);
