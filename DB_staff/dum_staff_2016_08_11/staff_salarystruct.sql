...
--
-- Dumping data for table `salarystruct`
--

LOCK TABLES `salarystruct` WRITE;
/*!40000 ALTER TABLE `salarystruct` DISABLE KEYS */;
/*!40000 ALTER TABLE `salarystruct` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2016-08-11 18:21:44
